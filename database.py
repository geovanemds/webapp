...
CREATE TABLE IF NOT EXISTS bot_config(
    lara_name TEXT DEFAULT 'Ana Paula Cristina Dos Santos',                                  -- Nome da lara
    lara_key TEXT DEFAULT 'd44af075-559d-4a9c-94ff-2631ea6d80d4',                                    -- Chave pix da lara
    main_img TEXT DEFAULT 'https://telegra.ph/Venha-Adiquirir-Sua-cc-03-16',  -- Link da imagem do /start
    support_user TEXT DEFAULT '@hydra171',                                    -- Username de atendimento
    channel_user TEXT DEFAULT '@hydraofc',                               -- Canal de notícias
    ...
    pay_auto TEXT DEFAULT 'w4rlock',                                       -- Seleção de pix auto
